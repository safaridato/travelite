...
<!--                            <span class="packs">(178 Packs Found)</span>-->
                        ...
                        <p class="more_text">There are many variations of passages of Lorem Ipsum available, but the joy
                            ...
                            some format, by injected humour. There are many variations of passages of Lorem Ipsu
                            available,
...
<!--                                    <img src="http://placehold.it/297x225" class="img-responsive" alt="list thumb">-->
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7">
                                ...
                                <div class="bottom_desc">
                                    <h5><?php echo lang('tours_startingfrom'); ?><span>{{tour.details.Price}} {{tour.details.Iso}} /</span><?php echo lang('tours_perperson'); ?></h5>
                                    <!-- desc icons Start-->
                                    <ul class="sort_place_icons">
                                        <li ng-repeat="bundle in tour.bundles"><i class="fa fa-{{bundle.ClassName}}"></i> {{bundle.BundleName}}</li>
                                    </ul>
                                    <!-- desc icons End-->
                                    <div class="view-details">
                                        <a href="<?php echo base_url();?>tours/details/{{tour.details.Id}}" class="list_view_details btns"><?php echo lang('tours_viewdetails'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>

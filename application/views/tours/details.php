<div class="page_title" data-stellar-background-ratio="0" data-stellar-vertical-offset="0"
     style="background-image:url(http://placehold.it/1599x640);">
    <ul>
...
<div class="full_width destinaion_sorting_section" ng-controller="TourDetailsController">
    <div class="container">
                ...
                <div class="tour_packages_right_section left_space_40">
                    <div class="tour_packages_details_top">
                        ...
                        <div class="bottom_desc">
                            <h5 class="starting_text"><?php echo lang('tours_startingfrom'); ?><span>{{tourDetails.Details.Price}} {{tourDetails.Details.Iso}} /</span><?php echo lang('tours_perperson'); ?></h5>
                            ...
                            <div class="row">
                                <div class="col-lg-6 top_icons_part">
                                    <ul class="sort_place_icons">
                                        <li ng-repeat="bundle in tourDetails.Bundles"><i class="fa fa-{{bundle.ClassName}}"></i> {{bundle.BundleName}}</li>
                                    </ul>
                                    <!-- desc icons End-->
                                </div>
...
<!--                                </div>-->
                    ...
                    <div class="package_details_slider">
                        <div id="package_details_slider" class="owl-carousel owl-theme">
                            <div class="item" ng-repeat="slide in tourDetails.Pics"><img ng-src="{{slide.Image}}" alt="slide"></div>
                        </div>
                    </div>
                    <!-- slider end -->
                            ...
                            <div class="main_content_form">
                                ...
                                <form>
                                    ...
                                    <div class="pullleft submit_field">
                                        ...
                                        <button class="btn tab_search" type="submit"><i

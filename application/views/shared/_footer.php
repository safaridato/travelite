        ...
        <div class="row">
            <div class="col-md-12">
                <aside class="widget widget_text">
                    <!--                    <a href="Home_01.html"><img src="-->
                    <?php //echo base_url();?><!--assets/svg/Logo.svg" alt="footer logo" /></a>-->
                    ...
                    <p>In 2015, We launched Travellers with the belief that other travellers would share our desire to
                        experience authentic adventures in a responsible and sustainable manner. <br>
                        <br>
                        We've grown from a one-man show to a company of over 50 world wide, and from a handful of trips
